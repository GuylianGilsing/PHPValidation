...
final class GreaterThanField implements FieldValidatorInterface
{
    private int|float $value;

    /**
     * This array field must be greater than the given value.
     */
    ...
    {
        return 'This field must be greater than: '.$this->value;
    }
}
