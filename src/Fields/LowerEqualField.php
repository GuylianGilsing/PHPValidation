...
final class LowerEqualField implements FieldValidatorInterface
{
    private int|float $value;

    /**
     * This array field must be lower than, or equal to, the given value.
     */
    ...
    {
        return 'This field must be lower than, or equal to: '.$this->value;
    }
}
